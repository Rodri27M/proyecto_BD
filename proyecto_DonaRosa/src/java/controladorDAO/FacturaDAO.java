...
public class FacturaDAO {
    ...
    public boolean insertarFactura(Factura factura){
        ...
        try (
            ...
            if (pstmt.executeUpdate() > 0) {
                String datosNuevos = String.format("Número: %s, Cliente: %s, Estado: %s", 
                    factura.getNumFac(), factura.getCodCli(), factura.getEstFac());
                auditoriaDAO.registrarAuditoria("FACTURA", factura.getNumFac(), 
    ...
    public boolean actualizarFactura(Factura factura) {
        ...
        try (
            ...
            if (pstmt.executeUpdate() > 0) {
                String datosNuevos = String.format("Número: %s, Estado: %s", 
    ...
    public boolean eliminarFactura(String numFac){
        ...
        try (
            ...
            if ( pstmt.executeUpdate() > 0) {
                auditoriaDAO.registrarAuditoria("FACTURA", numFac, 
